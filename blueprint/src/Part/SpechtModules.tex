...
\end{theorem}
\begin{proof}
    \uses{HomAeMisoeM, CuPropIdempotent, SmallerImpZero}
    ...
    Sinon $\mu = \lambda$ et on a une représentation de dimension 1 et par conséquent irréductible.\\
    Comme le nombre de partition de n est égale au nombre de classe de conjugaison de $S_n$ on a que tous les représentations de $S_n$ sont atteintes par un $V_{\mu}$.
\end{proof}